...
const ContactFormTypeScript: React.FC<formProps> = ({ call }) => {
  ...
  const [contactFormData, setContactFormData] = useState<formStates>({
    name: "",
    email: "",
    phone: "",
    subject: "",
...
export default ContactFormTypeScript;
